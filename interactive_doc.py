...
def open_documentation_window():
    ...
    # Add a search bar
    search_frame = ttk.Frame(doc_window)
   ...
   # Section for simple commands
    ...
    text="Examples of simple commands:\n\n"
         ...
         "16. Animate a shape:\n"
         "    animate -> C animate shape animation (define the proposed animations and speed)\n"
         "      example: C1 animate circle rotate\n"
         "      (From the cursor C1's location, animate the circle and make it rotate)",
    justify="left", wraplength=550)
    ...
    text="Change the color of a shape using the RGB model:\n\n"
         "1. Black:\n"
         "   fill_shape C (0, 0, 0)\n"
         "      example: fill_shape C1 (0, 0, 0)\n"
         "      (Fill the selected shape with black color)\n\n"
         "2. Blue:\n"
         "   fill_shape C (0, 0, 255)\n"
         "      example: fill_shape C1 (0, 0, 255)\n"
         "      (Fill the selected shape with blue color)\n\n"
         "3. Red:\n"
         "   fill_shape C (255, 0, 0)\n"
         "      example: fill_shape C1 (255, 0, 0)\n"
         "      (Fill the selected shape with red color)\n\n"
         "4. Green:\n"
         "   fill_shape C (0, 255, 0)\n"
         "      example: fill_shape C1 (0, 255, 0)\n"
         "      (Fill the selected shape with green color)\n\n"
         "5. Yellow:\n"
         "   fill_shape C (255, 255, 0)\n"
         "      example: fill_shape C1 (255, 255, 0)\n"
         "      (Fill the selected shape with yellow color)\n\n"
)
